...
class TxnMallTest(PHICOINTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 PHI:
        ...
        # 40 PHI serialized is 00286bee00000000
        pos0 = 2*(4+1+36+1+4+1)
        ...
        # Check node0's total balance; should be same as before the clone, + 100 PHI for 2 matured,

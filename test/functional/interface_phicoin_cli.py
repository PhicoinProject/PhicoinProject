...
class TestPHICOINCli(PHICOINTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `phicoin-cli getinfo`")
        ...
        self.log.info("Compare responses from `phicoin-cli -getinfo` and the RPCs data is retrieved from.")

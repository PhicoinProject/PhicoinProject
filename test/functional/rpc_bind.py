...
"""Test running phicoind with the -rpcbind and -rpcallowip options."""

import socket
import sys
from test_framework.test_framework import PHICOINTestFramework, SkipTest
...
class RPCBindTest(PHICOINTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-342, "non-JSON HTTP response with '403 Forbidden' from server", self.run_allowip_test, ['1.1.2'], non_loopback_ip, default_port)

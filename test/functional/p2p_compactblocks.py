...
# TestNode: A peer we use to send messages to phicoind, and store responses.
...
class CompactBlocksTest(PHICOINTestFramework):
    ...
    # This test actually causes phicoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that phicoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for phicoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # phicoind will not send blocktxn responses for blocks whose height is

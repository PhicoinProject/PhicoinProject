...
class AssetTest(PHICOINTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("PHICOIN1", 1000)
        n0.issue("PHICOIN2", 1000)
        n0.issue("PHICOIN3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="PHICOIN*", verbose=False, count=2, start=-2)
        ...
        phicoin_assets = n0.listassets(asset="PHICOIN*", verbose=False, count=2, start=-2)
        assert_equal(len(phicoin_assets), 2)
        assert_equal(phicoin_assets[0], "PHICOIN2")
        assert_equal(phicoin_assets[1], "PHICOIN3")
        self.sync_all()

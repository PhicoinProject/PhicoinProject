...
class BIP66Test(PHICOINTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # phicoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and phicoind produces more specific reject
            # reasons.

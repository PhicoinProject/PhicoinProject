...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the PHICOINTestFramework
    pass

class ExampleTest(PHICOINTestFramework):
    # Each functional test is a subclass of the PHICOINTestFramework class.
    ...
    def custom_method(self):
        ...
        PHICOINTestFramework class so other tests can use it."""

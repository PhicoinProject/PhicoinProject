...
class WalletTest(PHICOINTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 PHI from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 PHI with subtract fee from amount
        ...
        # Sendmany 10 PHI with subtract fee from amount

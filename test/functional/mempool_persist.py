...
By default, phicoind will dump mempool on shutdown and
...
class MempoolPersistTest(PHICOINTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give phicoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent phicoind from writing mempool.dat to disk. Verify that `savemempool` fails")

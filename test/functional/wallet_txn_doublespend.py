...
class TxnMallTest(PHICOINTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 PHI:
        ...
        # First: use raw transaction API to send 1240 PHI to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 PHI coin each
        ...
        # Node0's balance should be starting balance, plus 50PHI for another
        ...
        # Node0's total balance should be starting balance, plus 100PHI for 

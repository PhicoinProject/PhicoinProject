PHICOIN Core version *2.1.0* is now available!!
==============

  <https://github.com/PhicoinProject/phicoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/PhicoinProject/phicoin/commits/release_2.1.0>

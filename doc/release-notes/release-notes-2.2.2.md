PHICOIN Core version *2.2.2* is now available!!
==============

  <https://github.com/PhicoinProject/phicoin/releases/tag/v2.2.2>
...
- Enhancements for PHICOIN Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/PhicoinProject/phicoin/commits/release_2.2.2>

...
Below are some notes on how to build PHICOIN Core for Windows.
...
way. This will install to `c:\workspace\phicoin`, for example:

    make install DESTDIR=/mnt/c/workspace/phicoin

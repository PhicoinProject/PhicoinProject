...
This document provides guidelines for internationalization of the PHICOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `phicoin_en.ts` remains unchanged.

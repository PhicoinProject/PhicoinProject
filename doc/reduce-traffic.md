...
By default, phicoin-core allows up to 125 connections to different peers, 12 of
...
limits are tiny. Keep in mind that phicoin's trustless model works best if you are

...
find ${DISTNAME}/bin -type f -executable -exec ../PHICOIN/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../PHICOIN/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/PHICOIN/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/PHICOIN/depends/SDKs/MacOSX10.11.sdk.tar.gz

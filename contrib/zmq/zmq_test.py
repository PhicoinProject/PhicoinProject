...
"""
    ...
    PHICOIN should be started with the command line arguments:
        phicoind -testnet -daemon \
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND PHI issuance at " + str(pos))
				print("After PHI: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND PHI something at " + str(pos))
			start += pos+8
			print(astr)

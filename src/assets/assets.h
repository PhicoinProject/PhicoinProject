...
#ifndef PHICOIN_ASSET_PROTOCOL_H
#define PHICOIN_ASSET_PROTOCOL_H
...
#define DEFAULT_IPFS ""
#define MIN_ASSET_LENGTH 1
#define MAX_ASSET_LENGTH 256
#define OWNER_TAG "!"
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_PHICOIN_ASSET PHIQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_PHICOIN_ASSET PHIO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_PHICOIN_ASSET PHIR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_PHICOIN_ASSET PHIT
...
#endif //PHICOIN_ASSET_PROTOCOL_H

...
#ifndef PHICOIN_RPCSERVER_H
#define PHICOIN_RPCSERVER_H
...
/**
 * PHICOIN RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_isPHI = true);

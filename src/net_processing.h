...
#ifndef PHICOIN_NET_PROCESSING_H
#define PHICOIN_NET_PROCESSING_H
...
static constexpr int64_t HEADERS_DOWNLOAD_TIMEOUT_BASE = 10 * 60 * 1000000; // 10 minutes
...
static constexpr int64_t CHAIN_SYNC_TIMEOUT = 15 * 60; // 20 minutes
/** How frequently to check for stale tips, in seconds */
static constexpr int64_t STALE_CHECK_INTERVAL = 5 * 60; // 10 minutes

...
#ifndef PHICOIN_SCRIPT_STANDARD_H
#define PHICOIN_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_PHICOIN_ASSET script that carries data
    /** PHI END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a PHICOIN address
 */
...
/**
 * Generate a PHICOIN scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // PHICOIN_SCRIPT_STANDARD_H

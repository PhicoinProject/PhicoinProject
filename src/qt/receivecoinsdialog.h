...
#ifndef PHICOIN_QT_RECEIVECOINSDIALOG_H
#define PHICOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of phicoins */
...
#endif // PHICOIN_QT_RECEIVECOINSDIALOG_H

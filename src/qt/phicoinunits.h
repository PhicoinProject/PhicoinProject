...
#ifndef PHICOIN_QT_PHICOINUNITS_H
#define PHICOIN_QT_PHICOINUNITS_H
...
/** PHICOIN unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PHICOINUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PHICOINUnits(QObject *parent);
...
typedef PHICOINUnits::Unit PHICOINUnit;

#endif // PHICOIN_QT_PHICOINUNITS_H

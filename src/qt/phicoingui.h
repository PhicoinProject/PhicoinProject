...
#ifndef PHICOIN_QT_PHICOINGUI_H
#define PHICOIN_QT_PHICOINGUI_H
...
/**
  PHICOIN GUI main class. This class represents the main window of the PHICOIN UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PHICOINGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PHICOINGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~PHICOINGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a phicoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private:
    ...
    QComboBox *comboPHIUnit = nullptr;

...
#ifndef PHICOIN_QT_SENDASSETSENTRY_H
#define PHICOIN_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending phicoins.
...
#endif // PHICOIN_QT_SENDASSETSENTRY_H

    ...
    mapper(0)
{
    ...
    ui->phicoinAtStartup->setToolTip(ui->phicoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->phicoinAtStartup->setText(ui->phicoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openPHICOINConfButton->setToolTip(ui->openPHICOINConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new PHICOINUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->phicoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPHICOINConfButton_clicked()
{

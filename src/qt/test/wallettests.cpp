...
#include "qt/phicoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<PHICOINAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_phicoin-qt -platform xcb      # Linux
//     src/qt/test/test_phicoin-qt -platform windows  # Windows
//     src/qt/test/test_phicoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = PHICOINUnits::formatWithUnit(unit, balance, false, PHICOINUnits::separatorAlways);
    ...
    // Amount input
    PHICOINAmountField* amountInput = receiveCoinsDialog.findChild<PHICOINAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: phicoin:")) != -1);

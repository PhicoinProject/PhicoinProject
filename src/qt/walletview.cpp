...
void WalletView::setPHICOINGUI(PHICOINGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? PHICOINGUI::HD44_ENABLED : _walletModel->hdEnabled() ? PHICOINGUI::HD_ENABLED : PHICOINGUI::HD_DISABLED);

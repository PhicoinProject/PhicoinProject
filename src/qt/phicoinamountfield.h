...
#ifndef PHICOIN_QT_PHICOINAMOUNTFIELD_H
#define PHICOIN_QT_PHICOINAMOUNTFIELD_H
...
/** Widget for entering phicoin amounts.
  */
class PHICOINAmountField: public QWidget
{
    Q_OBJECT
...
public:
    explicit PHICOINAmountField(QWidget *parent = 0);
...
#endif // PHICOIN_QT_PHICOINAMOUNTFIELD_H

...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(PHICOINUnits::PHI),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->phiBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->phiBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(PHICOINUnits::formatWithUnit(unit, balance, false, PHICOINUnits::separatorAlways));
    ui->labelUnconfirmed->setText(PHICOINUnits::formatWithUnit(unit, unconfirmedBalance, false, PHICOINUnits::separatorAlways));
    ui->labelImmature->setText(PHICOINUnits::formatWithUnit(unit, immatureBalance, false, PHICOINUnits::separatorAlways));
    ui->labelTotal->setText(PHICOINUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, PHICOINUnits::separatorAlways));
    ui->labelWatchAvailable->setText(PHICOINUnits::formatWithUnit(unit, watchOnlyBalance, false, PHICOINUnits::separatorAlways));
    ui->labelWatchPending->setText(PHICOINUnits::formatWithUnit(unit, watchUnconfBalance, false, PHICOINUnits::separatorAlways));
    ui->labelWatchImmature->setText(PHICOINUnits::formatWithUnit(unit, watchImmatureBalance, false, PHICOINUnits::separatorAlways));
    ui->labelWatchTotal->setText(PHICOINUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, PHICOINUnits::separatorAlways));
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the PHI balance grid from expanding and looking terrible when asset balance is hidden

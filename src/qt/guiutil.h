...
#ifndef PHICOIN_QT_GUIUTIL_H
#define PHICOIN_QT_GUIUTIL_H
...
/** Utility functions used by the PHICOIN Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "phicoin:" URI into recipient object, return true on successful parsing

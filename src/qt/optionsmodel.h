...
#ifndef PHICOIN_QT_OPTIONSMODEL_H
#define PHICOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for PHICOIN client.
...
#endif // PHICOIN_QT_OPTIONSMODEL_H

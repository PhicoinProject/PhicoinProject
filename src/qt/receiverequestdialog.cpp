...
#include "config/phicoin-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatPHICOINURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + PHICOINUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatPHICOINURI(info));
}

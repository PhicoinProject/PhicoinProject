...
#ifndef PHICOIN_PRIMITIVES_BLOCK_H
#define PHICOIN_PRIMITIVES_BLOCK_H
...
extern uint32_t nPHIHASHActivationTime;
...
public:
    ...
    uint256 GetPHIHASHHeaderHash() const;
 ...
 * as input to PhiHash.
 */
class CPHIHASHInput : private CBlockHeader
{
public:
    CPHIHASHInput(const CBlockHeader &header)
    {
        CBlockHeader::SetNull();
        *((CBlockHeader*)this) = header;
    }
...
#endif // PHICOIN_PRIMITIVES_BLOCK_H

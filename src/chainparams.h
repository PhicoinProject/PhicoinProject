...
#ifndef PHICOIN_CHAINPARAMS_H
#define PHICOIN_CHAINPARAMS_H
 ...
 * PHICOIN system. There are three: the main network on which people trade goods
...
public:
    ...
    uint32_t GetPHIHASHActivationTime() const { return nPHIHASHActivationTime;}

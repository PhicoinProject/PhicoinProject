 ...
 */
#ifndef PHICOIN_UTIL_H
#define PHICOIN_UTIL_H
...
extern const char *const PHICOIN_CONF_FILENAME;
extern const char *const PHICOIN_PID_FILENAME;
...
{
    std::string s = strprintf("phicoin-%s", name);

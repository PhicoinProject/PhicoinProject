...
#ifndef PHICOIN_TEST_SCRIPTNUM10_H
#define PHICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from PHICOIN Core 0.10.0, for cross-comparison.
 */
public:

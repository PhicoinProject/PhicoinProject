...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler phi tx
        CScript phiTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut phiOut(1*COIN, phiTransfer);
        ...
        mutTxTest1.vout.emplace_back(phiOut);
        ...
        mutTxTest2.vout.emplace_back(phiOut);
        ...
        mutTxTest3.vout.emplace_back(phiOut);
        ...
        mutTxTest4.vout.emplace_back(phiOut);
        ...
        mutTxTest5.vout.emplace_back(phiOut);
        ...
        mutTxTest6.vout.emplace_back(phiOut);
        ...
        mutTxTest7.vout.emplace_back(phiOut);
        ...
        mutTxTest8.vout.emplace_back(phiOut);
